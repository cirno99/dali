...
RUN apk add --update --no-cache --repository https://mirrors.ustc.edu.cn/alpine/v3.18/main \
    build-base=0.5-r3 \
    clang=16.0.6-r1 \
...
RUN apk add --update --no-cache  \
    --repository=https://https://mirrors.ustc.edu.cn/alpine/v3.18/main  \
    --repository=https://https://mirrors.ustc.edu.cn/alpine/v3.18/community \
      expat-dev=2.6.2-r0 \
      giflib-dev=5.2.2-r0 \
      glib=2.76.6-r0 \
      lcms2=2.15-r2 \
